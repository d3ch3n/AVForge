...
Esta primeira fase é exclusivamente a modelagem estruturada de equipamentos. Ainda não há agentes, IA, banco de dados, código de aplicação ou geração de desenhos. A versão 3.2 estrutural do schema está em `schemas/equipment.schema.json` e os equipamentos ficam em `equipment/<vendor>/`.
